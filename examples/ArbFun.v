...
Existing Instance Gen_forall | 1.
...
Definition losing_strat (n : nat) : move :=
  if n < 10 then
    winning_strat n
  else
    take_2.
...
Compute (prop_winning 19 losing_strat winning_strat).

QuickChick (prop_winning 19 losing_strat).
